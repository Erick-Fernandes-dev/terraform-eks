...
| Name | Description |
|------|-------------|
| <a name="output_certificate_authority"></a> [certificate\_authority](#output\_certificate\_authority) | Imprimir o certificado da autoridade |
| <a name="output_cluster_name"></a> [cluster\_name](#output\_cluster\_name) | Imprimir o nome do cluster |
| <a name="output_eks_vpc_config"></a> [eks\_vpc\_config](#output\_eks\_vpc\_config) | Imprimir a configuração da VPC |
| <a name="output_endpoint"></a> [endpoint](#output\_endpoint) | n/a |
| <a name="output_oidc"></a> [oidc](#output\_oidc) | Impressão do OIDC |
<!-- END_TF_DOCS -->